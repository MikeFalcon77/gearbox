...
Claims: **204** — 203 built, 0 not built, 0 broken, 1 not observed.
...
| a key the backend does not read is shown with what it says, not dropped | `ADR-0023 §2.4: nothing is silently converted` | ✅ built |  |

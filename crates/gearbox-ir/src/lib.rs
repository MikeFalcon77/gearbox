...
pub use resolved::{
    ...
    CutSavings, Entrypoint, HostWorkersSettings, ImageRef, InclusionReason, KubernetesSettings,
    LOCK_SCHEMA_VERSION, ProcessKind, ResolvedBinding, ResolvedBindingMode, ResolvedClusterBinding,
    ResolvedEndpoint, ResolvedGear, ResolvedProcess, ResolvedProduct, ResolvedProductHeader,
    Selected, SpawnSpec, WorkerServe,
};

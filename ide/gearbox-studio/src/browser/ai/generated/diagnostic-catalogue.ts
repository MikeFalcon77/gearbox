...
export const DIAGNOSTIC_CATALOGUE: {
  ...
  GBX0311: {
    ...
    severity: "error",
    domain: "topology",
    docs: "A gear in the closure was not placed in any process.",
    requiresEvidence: false,
  },
  GBX0312: {
    code: "GBX0312",
